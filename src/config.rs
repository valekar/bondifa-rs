...
impl Config {
    ...
    pub fn set_web_socket_subscribe_endpoint<T: Into<String>>(mut self , web_socket_subscribe_endpoint : T) -> Self {
        self.web_socket_subscribe_endpoint = web_socket_subscribe_endpoint;
        self
    }

    pub fn set_web_socket_unsubscribe_endpoint<T: Into<String>>(mut self , web_socket_unsubscribe_endpoint : T) -> Self {
        self.web_socket_unsubscribe_endpoint = web_socket_unsubscribe_endpoint;
        self
    }
}